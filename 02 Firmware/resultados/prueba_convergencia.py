...
df1 = process_data("resultados/data1.txt")
df2 = process_data("resultados/data2.txt")
df3 = process_data("resultados/data3.txt")
df4 = process_data("resultados/data4.txt")
...
dfs = [df1, df2, df3, df4]
labels = ["Punto1", "Punto2", "Punto3", "Punto4"]
colors = ["#ffbe0b", "#1b9aaa", "#6a4c93", "#e63946"]
